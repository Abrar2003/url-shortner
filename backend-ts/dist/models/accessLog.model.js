...
const accessLogSchema = new mongoose_1.Schema({
    url_id: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'urls' },
    ip_address: { type: String, required: true },
    visit_time: { type: Date },
});
const AccessLogModel = mongoose_1.default.model('logs', accessLogSchema);
exports.default = AccessLogModel;
